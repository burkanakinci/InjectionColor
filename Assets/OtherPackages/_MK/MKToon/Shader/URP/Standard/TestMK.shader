...
Shader "MK/Toon/URP/Standard/TestMK"
{
	Properties
	{
		/////////////////
		...
		// Input       //
		/////////////////
		[PerRendererData][MainColor] _AlbedoColor ("", Color) = (1,1,1,1)
		...
		[PerRendererData]_Smoothness ("", Range(0, 1)) = 0.5
		...
		_GoochRamp ("", 2D) = "white" {}
		[PerRendererData]_GoochBrightColor ("", Color) = (1, 1, 1, 1)
		_GoochBrightMap ("", 2D) = "white" {}
		[PerRendererData]_GoochDarkColor ("", Color) = (0, 0, 0, 1)
